					...
					<div class="lineaForm">
						<b-form-group>
							...
							<b-form-invalid-feedback
								...
								v-if="
									$v.form1.denominacion.$dirty &&
									!$v.form1.denominacion.alphaNumSpc
								"
							>
								Recuerde ingresar sólo letras y
					...
					<div class="lineaForm" id="lineaDescripcion">
						<b-form-group>
							...
							<b-form-invalid-feedback
								...
								v-if="
									$v.form1.descripcion.$dirty &&
									!$v.form1.descripcion.alphaNumSpc
								"
							>
								Recuerde ingresar sólo letras y
								números.</b-form-invalid-feedback
					...
					<div class="lineaForm">
						<b-form-group>
							...
							<b-form-invalid-feedback
								...
								"
							>
								El tiempo en cocina sólo admite números enteros (sin coma ni
								punto)
							</b-form-invalid-feedback>
						</b-form-group>
					</div>
	...
	export default {
		...
		methods: {
			...
			onSubmit1() {
				...
				this.manufacturado.aptoCeliaco =
