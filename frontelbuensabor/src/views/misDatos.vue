	...
	<div>
		...
		<b-container class="informacion">
			...
			<div class="contenedorForm">
				<div class="lineaForm">
					<label class="tituloForm"> Nombre: </label>
					<b-form-input class="inputForm" v-model="user.nombre"></b-form-input>
				</div>
				<div class="lineaForm">
			...
			<b-button class="buttonText" @click="cambiarImagen">
				<img :src="require('@/assets/images/camera.png')" style="width: 25px" />
				...
				if (this.user.type === "Empleado") {
					await this.service
						...
						.then((data) => {
							this.user = data;
							this.$refs.modalCambioPass.hide();
							this.$bvToast.show("toast-cambiar-exito");
						})
						.catch(() => {
							this.$bvToast.show("toast-error-sistema");
						});
