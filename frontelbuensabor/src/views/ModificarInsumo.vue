					...
					<div class="lineaForm">
						<div class="form-group" style="width: 100%">
							...
							<b-form-invalid-feedback
								class="error"
								v-show="
									$v.form1.stockMin.$params.decimal &&
					...
					<div class="lineaForm">
						<div class="form-group" style="width: 100%">
							...
							<b-form-invalid-feedback
								class="error"
								v-show="
									$v.form1.stockMax.$params.decimal &&
				...
				<b-form id="form2">
					...
					<div class="container-fluid" v-if="esNuevo">
						<div class="row lineaFormDerecha">
							...
							<div class="col-4">
								<b-button pill class="boton" @click.prevent="volverPaso3"
									>Atrás</b-button
								>
							</div>
						</div>
			...
			<div id="paso3">
				...
				<b-form>
					...
					<div class="container-fluid" v-else-if="esNuevo">
						<div class="row lineaFormDerecha">
							<div class="col-4">
								<b-button pill class="boton2" @click="retornaAlStock"
									>Cancelar</b-button
								>
							</div>
							<div class="col-4">
								<b-button pill class="boton" @click="agregarInsumo"
									>Guardar</b-button
								>
							</div>
							<div class="col-4">
					...
					<div class="container-fluid" v-else>
						<div class="row lineaFormDerecha">
							...
							<div class="col-4">
								<b-button pill class="boton" @click="updateInsumo"
									>Guardar</b-button
								>
							</div>
							<div class="col-4">
...
<script>
	...
	const alphaNumSpc = helpers.regex(
		"alphaNumSpc",
		/^[a-zA-ZÀ-ÿ\d\u00f1\u00d1\s,./]*$/
	);
	export default {
		...
		methods: {
			...
			siguiente1() {
				...
				var stockDecimal =
					$("#stockMin").val().includes(".") ||
					$("#stockMax").val().includes(".");
