				...
				<b-form id="form1">
					...
					<div class="lineaForm" style="display: flex">
						...
						<b-form-invalid-feedback
							class="error"
							v-if="
								$v.form1.telefono.$params.integer &&
					...
					<div class="lineaForm" style="display: flex">
						...
						<b-form-invalid-feedback
							class="error"
							v-if="
								!$v.form1.calle.$params.alphaNumSpc &&
								$v.form1.calle.$model != ''
							"
						>
					...
					<div class="lineaForm" style="display: flex">
						...
						<b-form-invalid-feedback
							class="error"
							v-if="
								$v.form1.numero.$params.integer && $v.form1.numero.$model != ''
							"
						>
					...
					<div class="lineaForm" style="display: flex">
						...
						<b-form-invalid-feedback
							class="error"
							v-if="$v.form1.piso.$params.integer"
						>
					...
					<div class="lineaForm" style="display: flex">
						...
						<b-form-invalid-feedback
							class="error"
							v-if="
								$v.form1.localidad.$dirty && $v.form1.localidad.$model == ''
							"
						>
				...
				<b-form id="form2">
					...
					<div class="lineaForm" style="display: flex">
						...
						<b-form-invalid-feedback
							class="error"
							v-if="
								$v.form2.contrasenia.$dirty && $v.form2.contrasenia.$model == ''
							"
						>
